...
class HierarchicalBayesianHybridSoftmaxWithOwnRewardWithoutPartnerReward(
    ...
    def __init__(
        ...
        self.stan_file = os.path.join(
            module_path,
            "stan_files/hierarchical_social_hybrid_learning_with_own_rewards_without_partner_reward.stan",
        )
        self.group2ind = None
...
class WithinSubjectHierarchicalBayesianHybridSoftmaxWithOwnReward(
    ...
    def __init__(
        ...
        self.stan_file = os.path.join(
            module_path,
            "stan_files/within_subject_hierarchical_social_hybrid_learning_with_own_rewards_diff_sigma.stan",
        )
