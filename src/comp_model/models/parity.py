"""v1-to-canonical model parity matrix.

This module tracks capability parity coverage from the internal v1 model names
into the clean-slate canonical model names and plugin IDs.
"""
...
class LegacyModelParityEntry:
    """One parity mapping entry from v1 naming to canonical naming.

    Parameters
    ----------
    legacy_name : str
        Model name used in v1.
...
V1_MODEL_PARITY: tuple[LegacyModelParityEntry, ...] = (
...
__all__ = ["LegacyModelParityEntry", "V1_MODEL_PARITY"]
