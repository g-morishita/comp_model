...
- New user: read [First End-to-End Fit](tutorials/first-end-to-end-fit.md)
- Existing data workflow: see [Fit Existing CSV Data](how-to/fit-existing-csv-data.md)
- API lookup: use [API Overview](reference/api-overview.md)
- Architecture/rationale: read [Design Philosophy](explanation/design-philosophy.md)
