"""Convenience constructors for Vicarious Dirichlet-DB-Stay parameter bounds.
"""
...
def vicarious_dir_db_stay_bounds_space(
    *,
    beta_max: float = 20.0,
    ...
    """
    Return a bounds space for Vicarious Dirichlet-DB-Stay parameters.
    ...
    comp_model_core.params.ParameterBoundsSpace
        Bounds space consistent with :func:`~comp_model_impl.models.vicarious_dir_db_stay.schema.vicarious_dir_db_stay_schema`.
    """
