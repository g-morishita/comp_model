...
def vicarious_ap_vs_bounds_space(*, beta_max: float = 20.0, kappa_abs_max: float = 5.0) -> ParameterBoundsSpace:
   """
...
comp_model_core.params.ParameterBoundsSpace
    ...
    """
   return vicarious_ap_vs_schema(beta_max=float(beta_max), kappa_abs_max=float(kappa_abs_max)).bounds_space()
