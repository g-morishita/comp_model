data {
  ...
  int<lower=1,upper=8> alpha_vs_base_prior_family;
  real alpha_vs_base_prior_p1;
  real alpha_vs_base_prior_p2;
  real alpha_vs_base_prior_p3;
...
parameters {
  ...
  real<lower=0,upper=1> alpha_vs_base;
...
model {
  ...
  target += prior_lpdf(
    alpha_vs_base | alpha_vs_base_prior_family, alpha_vs_base_prior_p1, alpha_vs_base_prior_p2, alpha_vs_base_prior_p3
  );
