data {
  ...
  int<lower=1,upper=8> mu_aa_prior_family; real mu_aa_prior_p1; real mu_aa_prior_p2; real mu_aa_prior_p3;
  int<lower=1,upper=8> sd_aa_prior_family; real sd_aa_prior_p1; real sd_aa_prior_p2; real sd_aa_prior_p3;
...
model {
  ...
  target += prior_lpdf(mu_aa | mu_aa_prior_family, mu_aa_prior_p1, mu_aa_prior_p2, mu_aa_prior_p3);
  target += prior_lpdf(sd_aa | sd_aa_prior_family, sd_aa_prior_p1, sd_aa_prior_p2, sd_aa_prior_p3);
...
generated quantities {
  ...
  real alpha_a_pop = inv_logit(mu_aa);
  ...
  real mu_aa_hat = mu_aa;
  real sd_aa_hat = sd_aa;
  real mu_b_hat  = mu_b;
  real sd_b_hat  = sd_b;
}
