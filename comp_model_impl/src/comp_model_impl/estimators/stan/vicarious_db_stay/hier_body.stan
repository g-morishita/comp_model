data {
  ...
  int<lower=1,upper=8> mu_demo_bias_prior_family; real mu_demo_bias_prior_p1; real mu_demo_bias_prior_p2; real mu_demo_bias_prior_p3;
  int<lower=1,upper=8> sd_demo_bias_prior_family; real sd_demo_bias_prior_p1; real sd_demo_bias_prior_p2; real sd_demo_bias_prior_p3;
...
parameters {
  ...
  real mu_demo_bias; real<lower=0> sd_demo_bias; vector[N] z_demo_bias;
...
model {
  ...
  target += prior_lpdf(
    mu_demo_bias | mu_demo_bias_prior_family, mu_demo_bias_prior_p1, mu_demo_bias_prior_p2, mu_demo_bias_prior_p3
  );
  target += prior_lpdf(
    sd_demo_bias | sd_demo_bias_prior_family, sd_demo_bias_prior_p1, sd_demo_bias_prior_p2, sd_demo_bias_prior_p3
  );
  ...
  for (e in 1:E) {
    ...
    if (etype[e] == 1) {
      ...
      if (choice[e] > 0) {
        ...
        if (recent_demo_choice[n] > 0) u[recent_demo_choice[n]] += demo_bias[n];
...
generated quantities {
  ...
  real mu_demo_bias_hat = mu_demo_bias;
  real sd_demo_bias_hat = sd_demo_bias;
